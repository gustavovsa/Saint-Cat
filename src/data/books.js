...
links: {
    ...
    characters: [
      { name: "Gustavo", desc: "Gustavo conhece muito bem a dor da perda. A morte o acompanhou durante toda a sua vida, junto com o sofrimento e culpa. Por isso ele não se importa nenhum um pouco em se sacrificar para poder manter o bem daqueles que o cercam. Ficar sozinho de novo pode ser o maior medo de alguém que tanto já perdeu.", video: "/assets/euvideo.mkv" },
      { name: "Ana", desc: "Ana já teve que lidar com muita pressão, e por boa parte de sua vida, carregou uma certa tristeza que nunca ia embora. Ela chegou muito perto de perder sua fé, mas algo a fez ter vontade de lutar e não desistir. E agora, mais do que nunca, Ana tem que ser forte para lidar com os problemas que estão por vir.", video: "/assets/anavideo.mkv" },
      { name: "Hudson", desc: "Ele aprendeu a usar o Localizador muito rápido, o que mostra uma inteligência alta, pois não havia quem o ensinasse. Ele quase sempre será o primeiro a descobrir algo importante, o que o torna uma peça fundamental na vitória de todos.", video: "/assets/hvideo.mkv" },
      { name: "Carol", desc: "Carol tenta ser melhor toda vez, não voltar a cometer os mesmo erros, por mais que ela escorregue no meio do caminho. Seus traumas e passado jamais a deixarão, assim como suas ações. Mas ela ainda está disposta a lutar para melhorar. Ou só para não perder quem ama novamente.", video: "/assets/carolvideo.mkv" },
      { name: "Dayllon", desc: "Dayllon tem muitos traumas em seu passado, e sabe que não pode salvar todo mundo. Mas isso não o impede de continuar tentando, nem que ele tenha que se sacrificar para que isso aconteça. Pelo menos ele tem a esperança de que isso aconteça.", video: "/assets/dayllonvideo.mkv" },
      { name: "Laura", desc: "E apesar de tudo, no fim, Laura tem um bom coração. Ela só tem medo de cometer ou ver os outros cometendo os mesmos erros que ela novamente. Por isso acaba sendo rígida, como forma de não deixar as coisas saírem do controle.", video: "/assets/lauravideo.mkv" },
    ],
  },
  {
    id: "tm",
